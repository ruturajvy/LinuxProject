...
tunnel_src=public_network+'.2'
tunnel_dst=var_arr[6]
networks=var_arr[9].split()
...
f.write("\tauto=start\n")
f.write("\ttype=tunnel\n")
f.write("\tleft="+gre_network+".1\n")
f.write("\tleftid="+gre_network+".1\n")
f.write("\tleftsubnet="+var_arr[2]+"\n")
f.write("\tright="+gre_network+".2\n")
f.write("\trightsubnet="+networks[0]+"\n")
